import { TRAY_CARD_HEIGHT } from '../constants/cardTray';
...
export function HandEndDropZone({
  ...
  return (
    <div
      className={[
        `ml-1 flex ${TRAY_CARD_HEIGHT} w-6 shrink-0 items-center justify-center rounded-lg border-2 border-dashed transition-colors`,
        active
